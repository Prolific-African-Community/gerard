...
assert.throws(() => resolveNovotraluxDatabaseTarget({ VERCEL_ENV: 'production', NOVOTRALUX_CUSTOM_PRODUCTION_DATABASE_URL: 'postgres://production' }), /DATABASE_ENVIRONMENT_MISMATCH/, 'Production accepts documented Production endpoints only')
