# NOVOTRALUX DISPATCH — CONTEXT & RULES

## Project Overview

NOVOTRALUX Dispatch is an internal transport management and dispatching platform designed for NOVOTRALUX’s trucking and logistics operations.
