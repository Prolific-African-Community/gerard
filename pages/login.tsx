  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#F4F5F1] px-5 text-[#171814]">
      <section className="w-full max-w-[460px] rounded-[34px] border border-black/10 bg-white p-6 shadow-[0_24px_80px_rgba(17,18,15,0.12)] sm:p-8">
        <div>
          <OrganizationLogo className="h-10 w-auto object-contain" />
          <p className="mt-8 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#73796d]">
            Accès {branding.displayName}
          </p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <label className="block">
            ...
            <input
              ...
              className="mt-2 h-12 w-full rounded-2xl border border-black/10 bg-black/[0.025] px-4 text-sm font-semibold text-[#171814] outline-none transition placeholder:text-[#9aa090] focus:border-[var(--brand-accent)] focus:bg-white focus:ring-4 focus:ring-[var(--brand-accent-soft)]"
              placeholder="jerome"
            />
          </label>
          ...
          <button
            ...
            className="h-12 w-full rounded-2xl bg-[#11130f] px-4 text-sm font-semibold text-white shadow-[0_12px_32px_rgba(17,18,15,0.15)] transition hover:bg-[var(--brand-accent)] hover:text-black disabled:cursor-not-allowed disabled:bg-black/20 disabled:text-white"
          >
